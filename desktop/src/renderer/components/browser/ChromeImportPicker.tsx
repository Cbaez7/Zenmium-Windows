...
export function ChromeImportPicker({
  ...
  return <div className="zen-chrome-import-picker">
    ...
    {profiles.length === 0 && <p className="zen-overlay-help">Zenmium scans Google Chrome’s stable profile directory. Close Chrome before importing if a source database is busy.</p>}
