...
| ZEN-023 | Windows and Linux requested (Reddit, Mori #7) | Windows NSIS packaging, protocol/file launches, and stable Chrome-profile discovery are supported. Linux remains deferred. | Windows CI installer artifact |
